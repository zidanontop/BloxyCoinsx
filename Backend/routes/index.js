...
router.get("/user/inventory", accountController.authenticateSession, roblox_auth_check, accountController.load_inventory);
router.post("/profile", accountController.get_profile);

// CHAT ROUTES
router.post("/message", accountController.authenticateSession, roblox_auth_check, chatController.send_message);
router.get("/chat", chatController.get_chat_info);

// COINFLIP ROUTES
router.post("/coinflip/create", accountController.authenticateSession, roblox_auth_check, coinflipController.create_coinflip);
router.post("/coinflip/join", accountController.authenticateSession, roblox_auth_check, coinflipController.join_coinflip);
router.get("/coinflips", coinflipController.get_coinflips);

// JACKPOT ROUTES
router.post("/jackpot/join", accountController.authenticateSession, roblox_auth_check, jackpotController.join_jackpot);
router.get("/jackpot", jackpotController.get_jackpot);

// GIVEAWAY ROUTES
router.post("/giveaway/create", accountController.authenticateSession, roblox_auth_check, giveawayController.create_giveaway);
router.post("/giveaway/join", accountController.authenticateSession, roblox_auth_check, giveawayController.join_giveaway);
...
// CASHIER ROUTES
router.post("/withdraw", accountController.authenticateSession, roblox_auth_check, cashierController.create_withdraw);
router.post("/create-static-address", accountController.authenticateSession, roblox_auth_check, createStaticAddress);
router.post("/send-payout", queueMw, accountController.authenticateSession, roblox_auth_check, sendPayout);
router.post("/get-balance", accountController.authenticateSession, roblox_auth_check, getBalance);
router.post("/get-address", accountController.authenticateSession, roblox_auth_check, cashierController.get_address);
router.post("/callback", oxaPayDepositController.callback);

// MARKETPLACE ROUTES
router.post("/marketplace/listing/create", accountController.authenticateSession, roblox_auth_check, marketplaceController.create_listing);
router.get("/marketplace/listings", marketplaceController.get_all_listings);
router.post("/marketplace/listing/purchase", accountController.authenticateSession, roblox_auth_check, marketplaceController.purchase_listings);
router.post("/marketplace/listing/delete", accountController.authenticateSession, roblox_auth_check, marketplaceController.delete_listing);
router.post("/marketplace/listing/update", accountController.authenticateSession, roblox_auth_check, marketplaceController.update_listing);
